...
const ProductCard = ({ product }) => {
  ...
  return (
    <motion.div
      ...
      className="min-w-40 max-w-47 sm:max-w-full md:min-w-62.5 md:w-80 overflow-hidden dark:bg-black dark:text-white rounded-lg  shadow-md duration-300  hover:shadow-lg"
    >
      <img
